...
from src.features.system.tokenizer_runtime import (
...
class TokenizerRuntimeTests(unittest.TestCase):
    ...
    def test_gpt_models_prefer_tiktoken_backend_when_available(self) -> None:
        ...
        with patch('src.features.system.tokenizer_runtime._try_build_tiktoken_counter', return_value=fake_counter):
            with patch('src.features.system.tokenizer_runtime._try_build_transformers_counter', return_value=None):
    ...
    def test_transformers_backend_can_be_selected_with_env_override(self) -> None:
        ...
        with patch.dict(
            ...
            with patch('src.features.system.tokenizer_runtime._try_build_transformers_counter', return_value=fake_counter):
    ...
    def test_fallback_backend_is_used_when_all_tokenizers_fail(self) -> None:
        with patch('src.features.system.tokenizer_runtime._try_build_tiktoken_counter', return_value=None):
            with patch('src.features.system.tokenizer_runtime._try_build_transformers_counter', return_value=None):
